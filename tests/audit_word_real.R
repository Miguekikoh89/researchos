...
doc2 <- body_add_table(doc2, tbl_data, style="Table Normal")
...
doc_reg <- body_add_table(doc_reg, coef_df, style="Table Normal")
...
doc_log <- body_add_table(doc_log, log_df, style="Table Normal")
...
doc_aov <- body_add_table(doc_aov, aov_df, style="Table Normal")
...
chi_df <- data.frame(Estadistico=c("chi2","df","p"),
                      ...
                      stringsAsFactors=FALSE)
doc_chi <- body_add_table(doc_chi, chi_df, style="Table Normal")
...
doc_multi <- body_add_table(doc_multi, coef_df, style="Table Normal")
doc_multi <- body_add_par(doc_multi, "Tabla Logistica", style="heading 2")
doc_multi <- body_add_table(doc_multi, log_df, style="Table Normal")
