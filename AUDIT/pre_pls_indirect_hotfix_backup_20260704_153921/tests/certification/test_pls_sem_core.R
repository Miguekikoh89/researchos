...
params<-list(data_path=f,constructs=list(list(name="X",items=c("x1","x2","x3")),list(name="M",items=c("m1","m2","m3")),list(name="Y",items=c("y1","y2","y3"))),paths=list(list(from="X",to="M"),list(from="X",to="Y"),list(from="M",to="Y")),n_boot=1000,bootstrap_seed=1234)
...
cat("PASS núcleo PLS-SEM, bootstrap y fail-closed avanzado\n")
